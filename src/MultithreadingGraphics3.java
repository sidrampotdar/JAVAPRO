...
public class MultithreadingGraphics3 extends JPanel implements Runnable {

    private static final long serialVersionUID = 1L;
    private final int WIDTH = 800;
    private final int HEIGHT = 600;
    private final int SLEEP_TIME = 50; // milliseconds
    private final int NUM_SHAPES = 50;
    private Shape[] shapes;
    private Thread thread;
    private Random random;

    public MultithreadingGraphics3() {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Multithreading Graphics 3");
        frame.setSize(800, 600);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.add(new MultithreadingGraphics3());
