...
public class MultithreadingGraphics extends JPanel implements Runnable {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Multithreading Graphics");
        frame.setSize(800, 600);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.add(new MultithreadingGraphics());
